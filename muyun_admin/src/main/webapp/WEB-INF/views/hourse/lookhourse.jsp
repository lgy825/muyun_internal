...
<div class="p20">
    <div class="bgc-ff">
        ...
        <div class="p20">
            <input id="hId" type="hidden" value="${hId}" />
            <div class="">
                <!-- 必填选项 -->
                ...
                <div class="mt12">
                    ...
                    <input id="hNumber" maxlength="15" type="text" class="inpW set-inpwid ml8" placeholder="请输入房间号">
                    <span class="color-lred ml8 none">* 不超过15个字，不能出现其他特殊字符</span>
                </div>
                <div class="mt12">
                    <div class="align-r">地区编号</div>
                    <input id="hNumberArea" maxlength="15" type="text" class="inpW set-inpwid ml8" placeholder="请输入地区编号">
                    <span class="color-lred ml8 none">* 不超过15个字母或数字，不能出现其他特殊字符</span>
                </div>
                <div class="mt12">
                    <div class="align-r">地址</div>
                    <input id="hAddr" maxlength="10" type="text" class="inpW set-inpwid ml8" placeholder="请输入房子所在地址">
                ...
                <div class="mt12 clearfix">
                    ...
                    <div class="text-des ml8 fl"><textarea id="hDesc"></textarea></div>
