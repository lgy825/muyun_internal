...
public class Sqls {
    ...
    public Sqls andEqualTo(String property, Object value, boolean ignoreNull) {
    ...
    public Sqls andNotEqualTo(String property, Object value, boolean ignoreNull) {
        if (ignoreNull && value == null) {
            return this;
        }
        this.criteria.criterions.add(new Criterion(property, value, "<>", "and"));
    ...
    public Sqls andIn(String property, Iterable values, boolean ignoreEmpty) {
    ...
    public Sqls andLikeLeft(String property, String value) {
        if (StringUtils.hasText(value)) {
            value = "%" + value;
        }
        this.criteria.criterions.add(new Criterion(property, value, "like", "and"));
    ...
    public Sqls andLikeRight(String property, String value) {
        if (StringUtils.hasText(value)) {
            value = value + "%";
        }
        this.criteria.criterions.add(new Criterion(property, value, "like", "and"));
    ...
    public Sqls andLike(String property, String value, boolean ignoreNull) {
        if (ignoreNull && value == null) {
            return this;
        }
        if (StringUtils.hasText(value)) {
    ...
    public Sqls andLikeLeft(String property, String value, boolean ignoreNull) {
        if (ignoreNull && value == null) {
            return this;
        }
        if (StringUtils.hasText(value)) {
    ...
    public Sqls andLikeRight(String property, String value, boolean ignoreNull) {
        if (ignoreNull && value == null) {
            return this;
        }
        if (StringUtils.hasText(value)) {
